function Footer({mostrarSecciones=false}) {
    return (
        <>
            <footer id="footer">
                <div class="footer">
                    ...
                    <div class="footer-section">
                        <h5>Desarrollado por Facundo Gabriel Gaitán Segura</h5>
                    </div>

                    <div class="footer-section">
                        <h5>Contacto</h5>
                        <a href="mailto:facundogaitansegura@gmail.com">
                        ...
                        <a href="https://github.com/Facundo177">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 448 512">
                                <path
